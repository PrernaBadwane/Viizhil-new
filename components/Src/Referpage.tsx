...
const Referpage = () => {
  ...
  const openUserApp = () => {
    Linking.openURL("vizhil://referFriends"); // change path as needed
  };
  return (
    <View>
      ...
      <View style={{ ...styles.container }}>
        ...
        <View style={styles.subcontainer}>
          {/* Top Illustration */}
          <Image
            source={require("../../assets/images/Refers.png")}
            style={styles.illustration}
          />

          {/* Referral Message */}
          <Text style={styles.title}>
            Earn upto ₹50 per friend you invite to Vizhil
          </Text>
          ...
          {/* Refer Now Button */}
          <TouchableOpacity style={styles.referButton} onPress={openUserApp}>
